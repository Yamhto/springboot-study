package com.yamhto.mybatisPlus.generater;
 ...
 * @package com.yamhyo.mybatisPlus.generater
 * @description: mybatisPlus Generator
 * @date 2019/12/20 14:28
 */
public class Generator {

    private static final String database = "vhr";
    ...
    public static void main(String[] args) {
        generate("yamhto","com.yamhto.mybatisPlus", "");
    }
    ...
    private static GlobalConfig initGlobalConfig(String author, String packageName) {
        ...
        String tmp = Generator.class.getResource("").getPath();
        ...
        xmlPath = codeDir + "/src/main/resources" + "/mapper";
